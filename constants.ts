...
export const FEEDBACK_MATRIX: Record<string, Record<string, string>> = {
  ...
  'lv': {
    ...
    'wg': "Bestaat dit deel uit werkwoorden die een actie uitdrukken?",
  ...
  'bijzin': {
    ...
    'lv': "Zit er binnen dit deel een eigen onderwerp en persoonsvorm?",
    'mv': "Heeft dit deel een eigen persoonsvorm?",
    'vv': "Heeft dit deel een eigen onderwerp en persoonsvorm?",
